...
for i in range(128):
    search_tator =itertools.combinations_with_replacement(moon.search_space, 3)

    good_urls = [is_content(url) for url in search_tator]

    print([url.result() for url in good_urls])